    ...
    <>
      {variant === 'card' ? (
        ...
        >
          ...
          >
            <Map size={22} className="text-[#150408] group-hover:animate-pulse" />
          </div>
          
          <div className="flex-1 relative z-10">
            <div className="flex items-center gap-2 mb-1">
              <h3 className="text-lg font-bold text-[#150408] leading-tight" style={{ fontFamily: "var(--font-poppins)" }}>Live Fleet Tracking</h3>
            ...
            <p className="text-sm text-slate-500 font-medium">View real-time locations of 4 active tours</p>
          </div>
          
          <div
            className="w-10 h-10 rounded-full flex items-center justify-center group-hover:bg-[#F7B538] transition-colors relative z-10 text-slate-400 group-hover:text-[#150408]"
            style={{
              background: "#FAF0DF",
